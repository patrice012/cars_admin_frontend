...
export const SubmittedCars = () => {
  ...
  const filtres2 = [{ label: "brand", value: "brand" }];
  ...
  const handleSiteKeywordDetail = async (item: Item) => {
    if (!item._id) return;
    navigate(`/submitted_cars/${item._id}`, { state: { ...item } });
  };
  ...
  return (
    <>
      <Header page={"Submitted Cars"} headerStatus={""} />
      ...
      <div className="searches-container centerer">
            ...
            <div className="flex flex-col items-center justify-between ">
              <div className="flex items-center justify-between w-full">
                <div className="actions flex items-center justify-start gap-8">
                  {/* <button
                    onClick={() =>
                      toggleModal({ state: true, action: "create" })
                    }
        ...
        {isCreating && (
          <AddItem isOpen={isCreating} toggleModal={toggleModal} />
        )}
