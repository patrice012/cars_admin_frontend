...
export const SiteData = () => {
  ...
  const handleTableData = async () => {
    ...
    return await postReq(
      { page: pageNumber, perPage: META.perPage },
      "/api/site/list"
    );
  };
  ...
  // view site data
  const handleSiteKeywordDetail = async (elm) => {
    if (!elm._id) return;
    navigate(`/sites/${elm._id}`, { state: { ...elm } });
  };
  return (
    <>
      ...
      <CreateNewSite isOpen={isCreating} toggleModal={toggleModal} />
      <UpdateSite
        updateData={rowData}
        isOpen={isUpdating}
